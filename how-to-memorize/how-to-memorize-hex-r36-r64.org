...
#+begin_example
#+begin_src clojure :cache no :exports results :results ...
  (babomorph 0 10)
#+end_src
#+end_example
...
DONE: NEEDS WRITE UP --- GET RID OF THIS RULE
ANYTHING BEGINNING WITH S, Z, [WHY].[SZ] ENCODES A NUMBER
BEGINNING WITH ZERO.
ALSO NEEDS COMPLETION IN CORE.CLJ, WHERE I STOPPED AT 173.
