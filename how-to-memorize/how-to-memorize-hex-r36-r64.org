...
repetition. Here are the "mental movies":

1. ALPHA --- The alpha LION (ARYEH) is in the giant disneyland
   TEACUP. He is in JAIL and the jailer has her BACK turned to us.

2. BAKER --- is serving a BEEF meal to a JUDGE in full
   magistrate's dress including a powdered with on NOAH's ark in
   the little BOOTH (BAYIT) on top of the Ark.

3. CHARLIE --- is riding a CAMEL (GAMAL) looking at himself in the ME
   (mirror) having a hell of a time trying to tie his bow tie
   while bouncing around on the back of the camel and smoking a
   PIPE. The camel is dragging ropes with colored sidewalk chalk
   behind him making marks on the ground.

4. DELTA --- I am pointing a flashlight (RAY) at a giant,
   brass-and-wooden door (DELET) looking for a keyhole. I open it
   up and there is a PhD student who never finished his THESIS so
   must work as a CHEF. I see, hear, and smell the food he is
   cooking. Alternatively, a laser pointer is etching the blue
   lines around the margins of the THESIS paper (such was common
   in my day).

5. ECHO --- Moses is delivering the LAW on mount Sinai. A cop at the
   bottom of the hill (HAR) is holding up his hand: "stop!" In
   between his fingers there are poker CHIPS and pieces of
   Cinnamon TOAST. ECHO begins with "E", which is Greek Eta and
   looks like the letter "H" of hill and HAR. "Hill" and "har" are
   obvious cognates by a shift of the liquid consonants "l" and "r."

6. FOXTROT --- Lurch is clenching a pink (VERED) rose in his teeth
   and lantern JAW. He has an open CASE on his lap filled with a
   DOZEN more pink roses.

7. GOLF --- I have a golden (ZAHAV) KEY to my golf cart, where my
   black CAT is waiting with my golf TWOSOME.

8. HOTEL --- I am in the lobby of the beautiful Bellagio hotel
   with my donkey (CHAMOR) and a stinky CAN full of cigar butts and
   a DOWSER rod in my hands. I am waiting in line to pay the
   exorbitant FEE.

9. INDIA --- I am in a junkyard full of old Roll-Royce DIESEL
   automobiles with their camshafts poking out of their hoods. In
...
12. LIMA --- A girl is sunning herself and holding a silver
    ...
    is a loaf of bread (LECHEM) with flies buzzing around it. She
...
13. MIKE --- A pod of orca whales are flipping a Tam-O'Shanter
    ...
    TEASPON of water and drizzle it on a gigantic chocolate CAKE,
    the size of a five-gallon cylindrical barrel.

14. NOVEMBER --- A snake (NACHASH) is sizzling on a patch of hot
    TAR asphalt. It has neither arms nor legs, so, of course, it
    is wearing a shirt with CUFFS and TIGHTS instead of trousers
    (absurdity helps the memory).

15. OSCAR --- A TEETOTALER wearing a Carrie-Nation CAP is holding
    an Oscar award. A tiger with a striped TAIL is clenching a
...
17. QUEBEC --- A very FAT premier of Quebec is lying on a bed of
    TACKS and turning his face (PANIM) to a TOTEM to pray.

18. ROMEO --- has a sparrow (TZIPPOR) with her feet stuck in a
    patch of sticky TAFFY on his shoulder. He brings her to a
    TATAR princess, who is being FANNED by several slave girls.
...
20. TANGO --- A DEATHWATCH soldier with four arms and three swords
    is carrying Goliath's head (ROSH), which has a giant NOSE. He
    tangos toward a bus, where he mounts the steps and pays his
    FARE.

21. UNIFORM --- A skeleton (SHAD) FALLS into a NET with a HOT-DOG.
...
24. X-RAY --- NERO is playing his FIFE (not a fiddle) while
    watching Rome burn. He uses is X-RAY vision to look through
    the clothes of a bunch of DANCING people in they yard.

25. YANKEE --- An American flag is NAILED to the wall. Two nails
    stick out. A DOUGHNUT dangles from one nail and a watch-FOB is
    looped over the other nail.

26. ZULU --- An ATHENIAN comes up to BASE (baseball). Next to him
    is a NICHE with a bust of Athena in it.
...
:results:
|----+---------+----------+---------+----------+----------+---------|
| 20 | NOSE    | anise    | noose   | niece    | news     | nice    |
|    | noise   | ensue    | hence   | hens     | highness | once    |
...
|----+---------+----------+---------+----------+----------+---------|
| 25 | nail    | newel    | newly   | ni​l      | Ni​le     | null    |
