...
#+TITLE: How to Memorize Cards, GUIDs, Hashes, Public Keys, and More --- Revision 19
...
- Revision 17
  ...
  - Introduce PAO in Appendix [[PAO]]; Minor maintenance
...
=Ctrl-C Ctrl-C= while Emacs is visiting the file =core.clj=. If
you want to change prose or other aspects of the document, modify
the =.org= file and you won't have to bother with =core.clj=.
...
Here is a word that you may never have encountered before:
...
\begin{premise}{}
  ...
  Let's trick our minds into memorizing numerical or symbolic
  data via permanent associations between numbers and
   phantasmagorias.
  $\blacksquare$
\end{premise}

We'll find that we can memorize long sequences of numbers, long
lists of arbitrary items, whole texts verbatim, packs of shuffled
cards, etc., then recall them in any order by making up
phantasmagorias, or /phants/ for short. It's fun, easy, and
empowering. It requires some effort up front, but the effort is
incremental. It takes less than 30 minutes for anyone to learn how
to memorize lists of up to 10 items effortlessly and without
writing anything down. In a couple of weeks, anyone can learn to
memorize lists of up to 100 items effortlessly. That's good enough
for a lifetime of practical application. With a twist, PAO
(Appendix [[PAO]]), our list of 100 pegs becomes 300, The seriously
committed can spend a few months learning to memorize up to 1110
items effortlessly. All these methods and tricks are based on one
idea: the /peg/.
...
the memory task at hand. For example, in my personal version of the
...
images of favorite places that you normally visit in sequence,
...
For me, the pegs act just like a Memory Palace. I don't really
have a sequence of places that I visit frequently whose images I
can recall without effort. I /have/ practiced the pegs so much,
however, that I can recall them in sequence or at random without
effort. The pegs /are/ my memory palace.

That last point highlights the fact that these memory systems are
highly personal. I will show you the foundational pegs that
thousands or millions of people share, but you will be encouraged
to personalize it as much as necessary to make it strong and
...
- pegs :: permanent, immutable mental images in one-to-one
  ...
  phantasmagorically, and instantly think of the number 68.
  Likewise, whenever I see the number 68, I instantly visualize a
  chef, with his signature chef's hat and colored necktie, turning
  pancakes over. That's 1-to-1 correspondence.
...
- sound-alikes :: fluid, mutable lists of mental-images that are
  ...
  number. Typically, you make them up on-the-fly to devise a
  mental movie.
...
With PAO, the sequence 276872 becomes, more quickly, NEFERTIRI
TURNS a CIGAR, easy to visualize and hard to forget. PAO helps you
memorize long strings of numbers six at a time without devising
sound-alikes. Both methods work well, and I encourage you to
internalize them both, but in time. Master the pegs. PAO is built
on them.

To memorize data other than decimal numbers, like names,
hexadecimals, base-36 numbers, stories and speeches, we will
develop new sub-systems based on the pegs and on PAO. That is the
meat of this book. The key to /everything/, however, is to master
the pegs. Make them one of your memory palaces. For me, they are
my only memory palace. Some champion memorizers have many memory
palaces. I'm not in their league, but my system works amazingly
well for memorizing all kinds of data.

\clearpage
* Basic Pegs
<<basic-pegs>>

The pegs for the decimal digits are the foundation for the entire
system. All longer pegs, like CHEF for 68, are built up from
these. Here are my basic pegs, with some mnemonic hints:
...
# strings of numbers by devising a story (though see Appendix
# [[[[pao]]]] in the PAO system).
...
of sound-alikes. That's 1100 pegs by my count.

It is a very serious commitment to memorize 1100 pegs. My dad had
it, and John has done it. It will take months and it must be
refreshed frequently. I think it's more of an intellectual
challenge than a utility for memory, especially now that I've
adopted the PAO system (Appendix [[pao]]), which lets me easily and
quickly come up with phantasmagorias for any triple or sextuple of
digits base just on my 110 pegs for 0 through 9 and 00 through
99). However, I present the 1100-peg 3-digit system for the
adventurous mental mountaineers out there.

The 3-digit system comes in an old form and a new form. The old
form is based on Krill and Furst, like the 2-digit system. The new
system is from John and is presented below.

In the old system, the peg and sound-alikes for the 3-digit
...
H, WH, Y, and W are free. For example, ignore the H in HEMLINE
and think of HEMLINE as $MLN$ for $352$.

Vowel sounds are also free --- use as many or as few as you like.

From this point on, when we write "sound" or "sounds," we mean
"hard consonant sound" or "hard consonant sounds."

Ignore trailing sounds beyond the first three: MILLENNIAL and
MILLENIUM both encode 352.
...
Furst's tables are ambiguous for 3-digit pegs with leading 0.
For example, in his original, SEMOLINA appears under both 352
and 035. We can't have any ambiguity, however, so in our tables,
a leading S or Z sound encodes a number that begins with a 0.

TODO it is an arduous process to correct Furst's tables to move
all words with leading S or Z sounds into the tables for numbers
with leading zeros. As of Nov 2025, it's done through 360. I
(Brian) will complete the process as time permits. For now, be
tolerant and interpret any words with leading S or Z sounds,
perhaps with leading soft constants and vowels, as belonging to
...
It can be challenging to come up with more than 1100 3-digit pegs
out of the blue. Perhaps we could get to 1100 more easily by
...
|   B | astute     | hesitate    | sedate       | sedateness   | sedative    | sit-down   |
|     | stadium    | state       | state-line   | statesman    | statistical | status     |
|     | steadiness | steady      | stout        | stoutness    | stud        | student    |
|     | studious   | stutter     |              |              |             |            |
|-----+------------+-------------+--------------+--------------+-------------+------------|
| 012 | SATAN      | STEIN       | sedan        | stain        | satin       | stone      |
|   C | Estonia    | Sweden      | astound      | hesitant     | pseudonym   | sadden     |
|     | sadness    | satanic     | satisfaction | sit-in       | sodden      | stainless  |
|     | stand      | standard    | stench       | stenographer | stint       | stoneblind |
|     | stun       | stunt       | sudden       | sweeten      |             |            |
|-----+------------+-------------+--------------+--------------+-------------+------------|
| 013 | SEDIMENT   | STEAM       | sodium       | stem         | esteem      | wisdom     |
|   D | abstemious | estimate    | stamina      | stammer      | stamp       | stampede   |
|     | steamer    | steamfitter | steamship    | stimulant    | stomach     | stump      |
|-----+------------+-------------+--------------+--------------+-------------+------------|
| 014 | SATYR      | STAR        | Saturn       | stair        | cider       | cedar      |
|   E | Austria    | Easter      | Saturday     | astir        | astray      | astronaut  |
|     | austere    | historian   | historical   | history      | hysteria    | ouster     |
|     | oyster     | satire      | setter       | staircase    | star        | starch     |
|     | stare      | stark       | starling     | start        | steer       | sterile    |
|     | sterling   | stir        | stirrup      | storage      | store       | storehouse |
|     | storm      | story       | strafe       | straight     | strain      | strait     |
|     | strap      | stratagem   | straw        | strawberry   | streak      | stream     |
|     | streamer   | street      | strength     | stress       | stretch     | strict     |
|     | stride     | strife      | strike       | string       | strip       | stripe     |
|     | stroke     | stroll      | strong       | structure    | struggle    | strut      |
|     | sturdy     | sturgeon    | suitor       | swatter      | sweater     | yesterday  |
|-----+------------+-------------+--------------+--------------+-------------+------------|
| 015 | SADDLE     | STOOL       | still        | stall        | steel       | style      |
|   F | Stalin     | Steeler     | hostile      | sadly        | settle      | settlement |
|     | settler    | stale       | stalemate    | steal        | stealth     | stellar    |
|     | still-life | stillness   | styleless    | stylish      |             |            |
:end:
...
I recently learned the PAO---Person, Action, Object---system and
it's quickly becoming my favorite. Almost magically, it helps you
string long phantasmagorias together, 6 digits---three pegs---at a
time. It's built right on top of the peg system and it is a 3X
amplifier.

The PAO system associates 3 phantasmagorias in a little mini-movie
to each number. You build up your PAO system by enhancing and
stringing together the pegs you already know.

For example, consider these enhanced pegs:
...
Now, just from these, There are 64 different mini-movies you can
make up:

192929 CHIMP NAPS on the COUCH
192930 CHIMP NAPS at CHURCH
...
293019 PUSSYCAT LEAVES the BEER
...
301958 CONGREGATION TAPS CANADIAN MAPLE syrup

and so on.

I had a document numbered 30291958 the other day. I needed to
remember this number because I needed to refer to the document, by
number, in some other places. Without memory training, I would
have had to write it down, or copy-paste it to Notepad, or some
such annoying, time-consuming, distracting paper-cut of an
activity. Instead, I just created a mental movie.

If you had to memorize 30291958, you can do it the old way with
four pegs as described earlier in this book, or you can just pick
...
The CONGREGATION NAPS after drinking BEER and a BREEZE rustles
leaves.

I might end up with the same mental movie the old way, but this
way is faster and more robust. How about 40331626? DALE EARNHARDT
ROLLS EYEBALLS into a NICHE. How do I get DALE EARNHARDT? 40 is
RACE, and my PAO for RACE is DALE EARNHARDT CLIMBS into the window
of his famous #3 RACE CAR. 33 is MAMA, and my PAO is MAMA ROLLS
DOUGH (with a rolling pin). 16 is TISSUE, and my PAO is ALL GORE
DABS TEARS from his eyes with a tissue, as he weeps about global
warming. 26 is just NICHE, so I didn't invoke PAO for the last two
digits.

Knowing my pegs, it was actually almost too easy to come up with
my PAO system. The downside for you, the reader, is that my PAO is
even more personalized than my pegs. That fact makes it easy for
me to remember, but more difficult to teach. But I'll give it a go
anyway.

The key to building your own PAO is to make make sure the persons
are unique amongst themselves, ditto the actions and the objects.

My table is just an example. Fill out your own table to suit
yourself. You'll find it very quick to do and you will love
memorizing it because the pegs are a huge help.
...
Why do you need these single-digit entries? Here's one
application: phone numbers, at least in the US, come in 3-3-4
patterns. To remember 258-876-5309 (this is a complete fake: an
unassigned area code and the number from the old pop song that
everyone knows), I might do

NOAH STOPS a shower of GOLD, his LAWYER TWISTS ROSE STEMS, a
BARTENDER (53) SPILLS (09) a drink.

The only thing you didn't see from above is

53, BARTENDER SQUEEZES *LIME* into a bottle of Corona beer.
...
It would be a lengthy and uninstructive process to explain how I
came up with all these. Suffice it to say that /they work for me/
and you can make some that work for you!
...
|   G | hesitation     | stage-fright | stage-manager | stagecoach   | stagehand   | staging    |
|     | station        | stodgy       |               |              |             |            |
|-----+----------------+--------------+---------------+--------------+-------------+------------|
| 017 | STOCKING       | SIDECAR      | stake         | stick        | stucco      | stock      |
|   H | ascetic        | sciatica     | setting       | sidekick     | stack       | stacker    |
|     | stag           | stagger      | stagnant      | stakeholder  | stalk       | steak      |
|     | sticking       | stickup      | sticky        | stigma       | stigmata    | sting      |
|     | stock-exchange | stockbroker  | stockholder   | stocking     | stoic       | stoke      |
|     | stoker         | stuck        | suitcase      |              |             |            |
|-----+----------------+--------------+---------------+--------------+-------------+------------|
| 018 | STIFF          | STOVE        | staff         | stave        | stevedore   | sea-devil  |
|   I | set-off        | staffing     | stave-off     | stifle       | stove-pot   | stovepipe  |
|     | stuff          | stuffing     | wasteful      |              |             |            |
|-----+----------------+--------------+---------------+--------------+-------------+------------|
| 019 | STAB           | STEEPLE      | stub          | stoop        | staple      | steppe     |
|   J | eastbound      | estop        | seat-belt     | sideboard    | sideburns   | southbound |
|     | stable         | steep        | steeple       | step         | step-off    | stepfather |
|     | stepmother     | stipend      | stipulate     | stop         | stopover    | stoppage   |
|     | stopping       | stubborn     | stupefy       | stupid       | sweetbread  |            |
:end:
...
|   K | census      | easiness   | essence    | iciness    | science     | sensation |
|     | senseless   | sensible   | since      | sincere    | sinister    | sinus     |
|     | snooze      |            |            |            |             |           |
|-----+-------------+------------+------------+------------+-------------+-----------|
| 021 | SAINT       | SAND       | cent       | senate     | synod       | snot      |
|   L | Sunday      | ascent     | assent     | sandal     | sandbox     | sandwich  |
|     | sanity      | scent      | scientific | sent       | sentence    | sentiment |
|     | sentinel    | snit       | snoot      | snout      | sonata      | sonnet    |
|     | sound       | sound-box  | sundae     | swindle    | syndicate   | zenith    |
|-----+-------------+------------+------------+------------+-------------+-----------|
| 022 | SIGN-ON     | SAN JUAN   | assonance  | sea-onion  | snow-knife  | synonym   |
|   M | son-in-law  | asinine    | synonymous |            |             |           |
|-----+-------------+------------+------------+------------+-------------+-----------|
...
|   T | sauna-bath  | sign-up    | snapshot   | snub       | snub-nosed  | sunbeam   |
|     | sunup       | synopsis   |            |            |             |           |
:end:
...
|   V | assumed      | smite        | smooth       | something     | sometimes    | summed        |
|     | symmetric    | symmetry     |              |               |              |               |
|-----+--------------+--------------+--------------+---------------+--------------+---------------|
...
|   X | Summum Bonum | same man     | same mood    | semi-material | semi-member  | semimemorable |
|     | semi-metal   | semi-mobile  | semi-moist   | semimonthly   | semi-motile  | semi-motor    |
|-----+--------------+--------------+--------------+---------------+--------------+---------------|
| 034 | SAMURAI      | SWIMMER      | summer       | simmer        | smear        | summary       |
|   Y | smart        | smirk        |              |               |              |               |
|-----+--------------+--------------+--------------+---------------+--------------+---------------|
| 035 | SAWMILL      | SMILE        | semolina     | smell         | small        | simile        |
|   Z | sea-mile     | sea-mule     | seamless     | seemly        | similar      | smelt         |
|     | assimilate   | simulate     | simultaneous | smolder       | small-minded | smallpox      |
|-----+--------------+--------------+--------------+---------------+--------------+---------------|
...
|   p | tighten     | deaden       | detain      | detonate  | dead-end   |             |
|-----+-------------+--------------+-------------+-----------+------------+-------------|
...
|     | addendum     | identical   | identify    | whodunit     | astound    |           |
|-----+--------------+-------------+-------------+--------------+------------+-----------|
...
|     | down-payment | downbeat    | downpour    | donnybrook   | Danube     |           |
:end:
...
|     | admonish    | autumnal   | headman       | ottoman         |              |             |
|-----+-------------+------------+---------------+-----------------+--------------+-------------|
...
|     | admission   | automation | atom-age      | Edam-cheese     | estimation   |             |
|-----+-------------+------------+---------------+-----------------+--------------+-------------|
...
|     | dumbfounded | duumvirate | hit-movie     |                 |              |             |
|-----+-------------+------------+---------------+-----------------+--------------+-------------|
...
:results:
|-----+-----------+-------------+------------+-----------+-------------+-------------|
| 140 | TERRACE   | Thursday    | address    | atrocity  | authoress   | dress       |
|     | dresser   | dressing    | drizzle    | drowsy    | duress      | otherwise   |
|     | tea-rose  | thirst      | thrice     | throes    | torso       | trace       |
|     | tress     | trews       | tricycle   | truce     | waitress    |             |
|-----+-----------+-------------+------------+-----------+-------------+-------------|
| 141 | TURRET    | adroit      | authority  | dart      | dearth      | diehard     |
|     | dirt      | dread       | drought    | druid     | iterate     | outright    |
|     | tardy     | tart        | territory  | third     | thirteen    | thirty      |
|     | thread    | threat      | throat     | thyroid   | trade       | trait       |
|     | tread     | treadle     | treat      | treaty    | trident     | triton      |
|     | trout     | truth       | turtle     |           |             |             |
|-----+-----------+-------------+------------+-----------+-------------+-------------|
| 142 | TERRAIN   | adherent    | adorn      | astronaut | attorney    | darn        |
|     | dirndl    | drain       | drench     | drink     | drown       | drunk       |
|     | dryness   | eternal     | outrun     | thorn     | throne      | torrent     |
|     | tourney   | train       | trainee    | trance    | translation | transport   |
|     | trench    | turn        | turnip     | tyrant    | utterance   |             |
|-----+-----------+-------------+------------+-----------+-------------+-------------|
...
|     | uttermost | watermelon  | watermark  |           |             |             |
|-----+-----------+-------------+------------+-----------+-------------+-------------|
...
|     | water-lily  | astrologer | Waterloo     |           |            |            |
|-----+-------------+------------+--------------+-----------+------------+------------|
...
|     | hydrophobia | waterfall  | weather-vane |           |            |            |
|-----+-------------+------------+--------------+-----------+------------+------------|
...
|     | durable     | derby      | adorable     | attribute | water-boy  | waterproof |
:end:
...
|     | tallowless | teleology  | Dalai-Lama |            |             |            |
|-----+------------+------------+------------+------------+-------------+------------|
...
|     | hotshot      | whitewashed  |             |              |             |             |
|-----+--------------+--------------+-------------+--------------+-------------+-------------|
| 162 | EDITION      | tuition      | teach-in    | tee-joint    | dudgeon     | Dutch-uncle |
|     | addition     | audition     | outshine    | hesitation   |             |             |
|-----+--------------+--------------+-------------+--------------+-------------+-------------|
| 163 | TAJ-MAHAL    | touch-me-not | touchmark   | Dutchman     | attachment  |             |
|-----+--------------+--------------+-------------+--------------+-------------+-------------|
...
|     | doghouse     | dogs        | attics      | ethics     | outcast    |             |
|-----+--------------+-------------+-------------+------------+------------+-------------|
...
|-----+--------------+-------------+-------------+------------+------------+-------------|
| 172 | TOUCAN       | deacon      | decanter    | dignity    | taken      | tea-wagon   |
|     | technical    | thicken     | thickness   | token      | tycoon     |             |
|-----+--------------+-------------+-------------+------------+------------+-------------|
| 173 | DOCUMENT     | Tecumseh    | autogamy    | day-camp   | decamp     | decompose   |
|     | degum        | dogma       | thingumajig |            |            |             |
|-----+--------------+-------------+-------------+------------+------------+-------------|
| 174 | TIGER        | attacker    | autocar     | autograph  | dacron     | dagger      |
|     | decorate     | decrease    | decree      | decry      | degrade    | degree      |
|     | digger       | digress     | doggerel    | outcry     | outgrow    | tea-garden  |
|     | ticker       |             |             |            |            |             |
|-----+--------------+-------------+-------------+------------+------------+-------------|
| 175 | TACKLE       | dangle      | decal       | declaim    | declare    | decline     |
|     | ducal        | tag-line    | tangle      | tequila    | tickle     | tingle      |
|     | toggle       | tongue-lash |             |            |            |             |
|-----+--------------+-------------+-------------+------------+------------+-------------|
| 176 | DICTIONARY   | dockage     | dog-show    | doggish    | dogwatch   | education   |
|     | eduction     | take-issue  | tuck-shop   |            |            |             |
|-----+--------------+-------------+-------------+------------+------------+-------------|
| 177 | HOT-cake     | attacking   | decaying    | digging    | dogging    | outgoing    |
|     | tacking      | tagging     | tea-cake    |            |            |             |
|-----+--------------+-------------+-------------+------------+------------+-------------|
| 178 | DOGFISH      | TAKEOFF     | dog-food    | dogface    | dogfight   | dogfoot     |
|     | duckfooted   | hot-coffee  | outgiving   | tick-fever | tick-off   | wedding-vow |
|-----+--------------+-------------+-------------+------------+------------+-------------|
...
|-----+-------------+-------------+--------------+------------+----------------+---------------|
| 181 | DAVID       | Tophet      | daffodil     | daft       | davit          | defeat        |
|     | deft        | deviate     | devoid       | devote     | devout         | diphtheria    |
|     | diphthong   | divide      | eightfooter  | hotfoot    | outfit         | outvote       |
|     | taffeta     | theft       | tuft         | typhoid    |                |               |
|-----+-------------+-------------+--------------+------------+----------------+---------------|
...
|-----+-------------+-------------+--------------+------------+----------------+---------------|
| 185 | TEFILLIN    | defalcation | defile       | deflate    | develop        | devil         |
|     | duffel      | hateful     | hatful       | outfield   | outflow        | tivoli        |
|     | tofolli     | tough-luck  | toyful       | twofold    | white-elephant | wistful       |
|     | youthful    |             |              |            |                |               |
|-----+-------------+-------------+--------------+------------+----------------+---------------|
...
|     | edification |             |              |            |                |               |
|-----+-------------+-------------+--------------+------------+----------------+---------------|
| 188 | TV-fan      | two-fifths  | thief-vault  | dive-off   | eighty-five    |               |
|-----+-------------+-------------+--------------+------------+----------------+---------------|
| 189 | DIVE-BOMBER | taffy-pull  | tough-boy    | edifiable  |                |               |
:end:
...
:results:
|-----+--------------+---------------+-------------+------------+-------------+-------------|
| 190 | TAPAS        | autobus       | autopsy     | debase     | deposit     | dubious     |
|     | headpiece    | outpace       | tapestry    | tips       | tipsy       | top-secret  |
|     | top-sergeant | tops          | topsail     | topside    | topsoil     | topsy-turvy |
|     | tubes        | tubs          | types       |            |             |             |
|-----+--------------+---------------+-------------+------------+-------------+-------------|
| 191 | DEBUTANT     | adapt         | adept       | adopt      | debate      | debit       |
|     | depth        | deputy        | hotbed      | outbid     | output      | teapot      |
|     | tepid        | tiptoe        | top-dog     | top-hat    | topdrawer   | towpath     |
|     | two-bit      |               |             |            |             |             |
|-----+--------------+---------------+-------------+------------+-------------+-------------|
...
|-----+--------------+---------------+-------------+------------+-------------+-------------|
| 193 | topman       | topmast       | topmost     | top-milk   | topminnow   |             |
|-----+--------------+---------------+-------------+------------+-------------+-------------|
| 194 | TYPEWRITER   | dapper        | daybreak    | debar      | debris      | depart      |
|     | department   | deportment    | depreciate  | depress    | deprive     | diaper      |
|     | dipper       | outboard      | outbreak    | taper      | tapir       | taproom     |
|     | tea-party    | tie-bar       | top-rate    | top-round  | topper      | topwork     |
|-----+--------------+---------------+-------------+------------+-------------+-------------|
| 195 | TABLE        | audible       | dapple      | deplore    | diabolic    | diploma     |
|     | diplomat     | double        | doublet     | duplicate  | edible      | oddball     |
|     | tableau      | tablet        | tipple      | topless    | topple      | tupelo      |
|     | two-ply      |               |             |            |             |             |
|-----+--------------+---------------+-------------+------------+-------------+-------------|
| 196 | DEBAUCH      | adaption      | adoption    | tip-sheet  | top-sheet   | top-shelf   |
|     | two-page     | type-wash     |             |            |             |             |
|-----+--------------+---------------+-------------+------------+-------------+-------------|
| 197 | TOBACCO      | autobiography | debacle     | debug      | depict      | dipping     |
|     | hatbox       | tapping       | tea-bag     | toboggan   | topcoat     | topic       |
|     | topkick      | topping       | typical     | typing     | typography  |             |
|-----+--------------+---------------+-------------+------------+-------------+-------------|
| 198 | TYPEFACE     | deep-felt     | deepfreeze  | tip-off    | top-heavy   | topflight   |
|     | two-by-four  | typify        |             |            |             |             |
|-----+--------------+---------------+-------------+------------+-------------+-------------|
...
|-----+----------------+---------------+--------------+--------------+----------------+---------------|
| 204 | CENSOR         | answer        | encircle     | incertitude  | insert         | insurgent     |
|     | insurmountable | insurrection  | newsreel     | newsworthy   | uncertain      | unsworn       |
|-----+----------------+---------------+--------------+--------------+----------------+---------------|
| 205 | NACELLE        | ancillary     | enslave      | insolence    | insolvent      | insular       |
|     | insulin        | insult        | nasal        | nestle       | nicely         | noiseless     |
|     | nozzle         | nuzzle        | oneself      | unselfish    | wine-cellar    |               |
|-----+----------------+---------------+--------------+--------------+----------------+---------------|
| 206 | NOSE-JOB       | news-agency   | incision     | ionization   | unsociable     |               |
|-----+----------------+---------------+--------------+--------------+----------------+---------------|
...
:results:
|-----+-----------------+-------------+--------------+-------------+---------------+----------------|
| 210 | NUDIST          | Nazi        | antacid      | anticipate  | antiseptic    | enthusiasm     |
|     | entice          | handsaw     | hind-sight   | indecent    | indistinct    | induce         |
|     | industry        | no-dice     | notice       | nowadays    | undeserved    | undesirable    |
|     | undisturbed     |             |              |             |               |                |
|-----+-----------------+-------------+--------------+-------------+---------------+----------------|
| 211 | UNTIED          | annotate    | antidote     | antitrust   | entitle       | entity         |
|     | handed          | handout     | haunted      | indeed      | knighthood    | needed         |
|     | night-duty      | nitwit      | noted        | nudity      | undated       | undoubted      |
|     | united          | untidy      | want-ad      |             |               |                |
|-----+-----------------+-------------+--------------+-------------+---------------+----------------|
| 212 | ANTENNA         | Anthony     | Indian       | andante     | antiknock     | antonym        |
|     | centennial      | entwine     | handiness    | inattentive | indent        | india-ink      |
|     | intend          | intense     | intonate     | one-to-one  | undeniable    | unthankful     |
|     | wanton          |             |              |             |               |                |
|-----+-----------------+-------------+--------------+-------------+---------------+----------------|
...
|     | ointment        | on-time     | onetime      | untimely    | windmill      |                |
|-----+-----------------+-------------+--------------+-------------+---------------+----------------|
| 214 | NUTTER          | Netherlands | Unitarian    | another     | anterior      | anteroom       |
|     | anthracite      | endear      | endorse      | endure      | enter         | entertain      |
|     | entrance        | entry       | handrail     | handwriting | hinterland    | hundred        |
|     | interact        | interest    | interior     | intern      | international | interval       |
|     | interview       | introduce   | neither      | network     | neutral       | nightrobe      |
|     | nitrate         | nitric      | nodder       | notary      | nutriment     | under          |
...
|     | needle          | needless    | new-deal     | night-owl   | until         | windless       |
|-----+-----------------+-------------+--------------+-------------+---------------+----------------|
...
|     | unenlarged     | unanalyzed     | union-hall    | union-labor   | union-leader    |                   |
|-----+----------------+----------------+---------------+---------------+-----------------+-------------------|
...
|     | unimproved | unimpressive | unambiguous   | unamiable    | unhampered  |             |
:end:
...
|     | inconvertible | unacquainted  | unconcerned   | unkind       |              |                |
|-----+---------------+---------------+---------------+--------------+--------------+----------------|
...
|-----+--------------+-------------+-------------+---------------+---------------+--------------|
| 296 | nuptials     | honey-beige | one-page    | inhibition    | unabashed     |              |
|-----+--------------+-------------+-------------+---------------+---------------+--------------|
...
|     | misnomer      | misunderstand | mizzen      | muezzin       | Amazon        |             |
|-----+---------------+---------------+-------------+---------------+---------------+-------------|
...
|     | ominous     |               |              |            |              |             |
|-----+-------------+---------------+--------------+------------+--------------+-------------|
| 321 | amend       | amenity       | amount       | emanate    | humanity     | immunity    |
|     | maintain    | man-eater     | man-trap     | mandate    | mandolin     | Manhattan   |
|     | manhood     | mantle        | maundy       | meantime   | mend         | mental      |
|     | mentor      | mind          | minidress    | mint       | minute       | Monday      |
|     | monitor     | monotonous    | month        | mountain   | womanhood    |             |
|-----+-------------+---------------+--------------+------------+--------------+-------------|
...
|     | ohmmeter     |            |                |            |           |            |
|-----+--------------+------------+----------------+------------+-----------+------------|
| 332 | mammon       | memento    | Miamian        | moment     | momentum  |            |
|-----+--------------+------------+----------------+------------+-----------+------------|
| 333 | mimamsa      | mamamu     | mamma-mia      |            |           |            |
|-----+--------------+------------+----------------+------------+-----------+------------|
...
|     | myrtle      | myriad      | hammer-throw | homeward   |            |            |
|-----+-------------+-------------+--------------+------------+------------+------------|
...
|-----+-------------+---------------+-------------+-------------+------------+-------------|
| 351 | MALT        | melt          | mold        | omelet      | mulatto    | emulate     |
|     | hamlet      | homiletics    | humility    | malady      | mallet     | meld        |
|     | melodrama   | melody        | milady      | mild        | military   | millet      |
|     | muleteer    | multiple      | multitude   | umlaut      |            |             |
|-----+-------------+---------------+-------------+-------------+------------+-------------|
| 352 | MELON       | Himalayans    | hemline     | milliner    | homeland   | malign      |
|     | melancholy  | millennial    | millennium  | million     |            |             |
|-----+-------------+---------------+-------------+-------------+------------+-------------|
| 353 | mailman     | maim          | melamine    | millimeter  | millman    | muleman     |
|     | mule-mark   | mealymouthed  | emolument   |             |            |             |
|-----+-------------+---------------+-------------+-------------+------------+-------------|
| 354 | molar       | miler         | malaria     | miller      | milliard   | mealworm    |
|     | mailer      | milord        | millwright  | ameliorate  |            |             |
|-----+-------------+---------------+-------------+-------------+------------+-------------|
...
|     | malapert    | malaprop      | mulberry    | muleback    |            |             |
:end:
