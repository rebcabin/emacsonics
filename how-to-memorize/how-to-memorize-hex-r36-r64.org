...
\clearpage
#+begin_src clojure :cache no :exports results :results verbatim drawer output
  (babomorph 20 30)
#+end_src
...
|   Q |          |            |           |            |           |          |
|-----+----------+------------+-----------+------------+-----------+----------|
| 027 | SINK     | snack      | snake     | snick      | zinc      | cynic    |
|   R | scenic   | sea-anchor | sneak     | snug       |           |          |
|-----+----------+------------+-----------+------------+-----------+----------|
| 028 | SNUFF    | sniff      | snafu     | sniffle    | saw-knife | Seinfeld |
|   S | sinful   |            |           |            |           |          |
|-----+----------+------------+-----------+------------+-----------+----------|
...
|     | unversed      |             |             |               |              |               |
|-----+---------------+-------------+-------------+---------------+--------------+---------------|
| 285 | Seinfeld      | anvil       | envelope    | infallible    | infield      | inflame       |
|     | inflate       | inflict     | inflow      | influence     | influenza    | invalid       |
|     | invaluable    | involuntary | involve     | invulnerable  | naval        | navel         |
|     | novel         | sinful      | sniffle     | snowflake     | unavailable  | unfilled      |
|     | unflattering  | unfold      | univalve    | unveil        |              |               |
|-----+---------------+-------------+-------------+---------------+--------------+---------------|
...
:results:
|-----+------------+--------------+-------------+---------------+---------------+--------------|
| 290 | NBC        | knapsack     | knobs       | nabs          | naps          | nibs         |
|     | nips       | nubs         | synopsis    | unbiased      | unobscured    | unobserved   |
|     | unopposed  |              |             |               |               |              |
|-----+------------+--------------+-------------+---------------+---------------+--------------|
...
|-----+------------+--------------+-------------+---------------+---------------+--------------|
| 295 | showball   | nibble       | nipple      | nebulous      | niblick       | nobleman     |
|     | nubile     | Naples       | Napoleon    | Hannibal      | Nobel         | enable       |
|     | inability  | inapplicable | unable      | unbelief      | unbolt        | unbalanced   |
|     | unpleasant |              |             |               |               |              |
|-----+------------+--------------+-------------+---------------+---------------+--------------|
...
:results:
|-----+-------------+------------+--------------+--------------+-----------+--------------|
| 750 | calcium     | callous    | calls        | cholesterol  | clasp     | class        |
|     | clause      | close      | closet       | cluster      | colossus  | equalize     |
|     | gallows     | glass      | glaze        | glissade     | gloss     | isinglass    |
|     | oculist     |            |              |              |           |              |
|-----+-------------+------------+--------------+--------------+-----------+--------------|
