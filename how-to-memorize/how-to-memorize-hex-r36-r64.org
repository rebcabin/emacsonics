...
#+TITLE: How to Memorize Cards, GUIDs, Hashes, Public Keys, and More --- Revision 14
...
- Revision 12
  ...
  - Reworking the 3-digit pegs; adding new technique.
...
[Brian] My Dad taught me the peg system when I was a child. I
later found sources to back it up, specifically Krill[fn::
...
- pegs :: permanent, immutable mental images in one-to-one
  correspondence with numbers. For instance, the number 68, for
  me, is a chef. Whenever I see a chef or think of one, I smell
  the kitchen and hear the sounds of boiling and sizzling
  phantasmagorically, and I instantly think of the number 68.
  That's 1-to-1 correspondence.
...
|   Z | seamless | seemly | similar |       |        |          |
:end:

*** TODO Exceptions

/Seamless/ and /similar/ are apparent exceptions to the rule,
inherited in this list from Furst. Fix this.
...
** TODO New 3-Digit System

In the old system, the sounds $xyz$ for $abc$ can be
$hxyzh\ldots$, where $h$ stands for any weak sound or, in the
leading position, S or Z sound. In the more permissive, new system
(under development), 3-digit codes are $xyh\ldots{}zh\ldots{}$. For
example:
...
a block of ten and can reuse $zh\ldots$ for all ten pegs in
multiple blocks of ten.
...
[[card-pack]]). I know this table by heart.
# My Dad and many memory
# experts know pegs for 3 digits by heart and "compute" sound-alikes
# on-the-fly. This document records my journey to a 3-digit holding.
...
Items in ALL CAPS are pegs recommended because they're visually
strong. The first row in each block contains recommended
alternatives in preference order. The rest of the rows are in
alphabetical order.
...
This list is automatically constructed from a file named
/core.clj/ deeper in the directory tree of the source repository.
...
|----+---------+----------+---------+----------+-----------+---------|
| 06 | SASH    | sausage  | swatch  | sage     | ice-show  | siege   |
|    | assuage | ice-age  | sashay  | sedge    | sewage    | such    |
|    | switch  | usage    |         |          |           |         |
|----+---------+----------+---------+----------+-----------+---------|
| 07 | SOCK    | sack     | ski     | sky      | scow      | sake    |
|    | sea-cow | ask      | assegai | hoosegow | housing   | husky   |
|    | icing   | sago     | seek    | sick     | soak      | soggy   |
...
|    | amigo   | Mohawk  | amok   | among     | make   | meek    |
|    | mock    | muck    | omega  |           |        |         |
|----+---------+---------+--------+-----------+--------+---------|
...
|----+---------+-----------+----------+--------+---------+--------|
| 41 | RAT     | ROAD      | aorta    | arid   | aright  | art    |
|    | award   | earth     | erode    | errata | hard    | hart   |
|    | heart   | hearth    | herd     | hereto | hoard   | horde  |
|    | horrid  | hurried   | hurt     | radio  | raid    | rate   |
|    | read    | ready     | red      | reed   | rid     | ride   |
|    | right   | riot      | rite     | rod    | root    | rot    |
|    | route   | rut       | ward     | wart   | weird   | word   |
|    | worried | worth     | wrath    | wreath | wreathe | write  |
|    | yard    |           |          |        |         |        |
|----+---------+-----------+----------+--------+---------+--------|
...
|    | aerify  | arrive    | horrify  | rave   | rive    | roof   |
|    | rough   | rove      | ruff     | wharf  |         |        |
|----+---------+-----------+----------+--------+---------+--------|
...
|    | Walhalla  | hallelujah | holy-oil | hula-hula | ill-will | lolly     |
|    | lull      | lulu       | oil-well | whale-oil |          |           |
|----+-----------+------------+----------+-----------+----------+-----------|
...
|    | ailing    | alike      | along    | elk       | hillock  | hollyhock |
|    | hulk      | ilk        | leak     | leek      | leg      | lick      |
|    | like      | lock       | loco     | log       | long     | look      |
|    | low-key   | luck       | lug      | lung      | whaling  |           |
|----+-----------+------------+----------+-----------+----------+-----------|
| 58 | LEAF      | WOLF       | lava     | laugh     | leave    | life      |
|    | alive     | aloof      | elf      | levee     | levy     | live      |
|    | loaf      | love       | luff     | olive     | welloff  |           |
|----+-----------+------------+----------+-----------+----------+-----------|
| 59 | LAP       | WALLABY    | lab      | leap      | lip      | lob       |
|    | alibi     | alp        | elbow    | elope     | help     | lobby     |
|    | lobe      | loop       | lop      | lowboy    | wallop   | whelp     |
:end:
...
|  M | calk    | cock      | coke   | cacao   | cuckoo   | gag     |
|    | gangway | gang      | going  | goo-goo | gook     | kaka    |
|    | kayak   | khaki     | kick   | keg     | quack    | quake   |
|    | quick   | aching    | agog   |         |          |         |
|----+---------+-----------+--------+---------+----------+---------|
...
|----+---------+-----------+--------+---------+----------+---------|
| 79 | CAP     | cob       | cowboy | cab     | guppy    | cube    |
