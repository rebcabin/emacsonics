...
#+TITLE: How to Memorize Random Data
...
Most of my methods make mental cartoon movies or pseudo-poems from
picture words. Others (more talented than I) can make up rhyming
or musical lyrics on-the-fly!
...
Furst, and to Allan Krill for this list and all others in this
document.

** Sound-Alikes

Finding a word phonetically near another one is an act of
"computing" or "calculating" a picture word. For example, the peg
for 37 is "mike," and I picture a microphone in my hand and feel
the electrical tingling due to poor grounding in my hand (we've
all experienced that on stage, haven't we?). Adding some
synaesthesia or emotion to pegs helps my memory. Others may not
find that helpful. Do what is best for you!
...
Krill calls these hallucinations, "phantasmagorishes," a word
that, itself, encodes 5210 3746, a near pangram of the system,
missing only the digits 1 and 9.
...
pseudo-poem easily. It's bad to have an idea-chain the breaks
...
recall the peg without effort. I changed a few pegs once for
teaching purposes because my originals got dated and I regretted
it. The ones I learned first keep popping up and slowing me down.

\clearpage
* Basic Peg Lists
<<basic-pegs>>

My basic extended 2-digit peg list appears in Table 1, and the 1-digit
list with rules for calculating sound-alikes appears in Table 2.
Vowels and soft consonants like h, w, and y are free when
calculating new words off the list as you can see in Section
[[all-pegs]].
...
|  08 | safety   |  18 | taffy  |  28 | navy      |  38 | muff       |
...
I prefer method 1. It extends to higher radices, as we see in
Section [[public-keys]].
...
adjective,words like "the," "this," and "that;" forms of the verb
"to be," and other obvious connector words. Let's take a look at
a statue in the artist's studio:
...
Not bad for 15 minutes' time to construct it, using the tables as
a crutch.

It will take more time to memorize the hallucination above, but
not much. Memorize and check yourself tomorrow.
...
This key is in radix 64. A method-1 encoding of "Rixits,"
reserving 010 through 064, follows:
...
- Problem 1: off-by-one :: you may notice that 24 is "O," but you may
  remember that "O" is also the 15-th capital glyph of the
  alphabet (see Table 3). Adding 10 for the first ten digits of
  the encoding, $15+A = 15+10 = 25$", not 24. This is an
  opportunity for error at speed. But we can deal with it.

  To encode O, remembered as the 15-th letter, first subtract 1 to
  correct the off-by-one error, getting 14. Then add 10 to account
  for the leading ten digits $0..9$ of the encoding, getting 24.
  Prepend the leading $s=0$ for the radix to get $024$, say
  "sunrise."
...
- Problem 2: ASCII :: If you've memorized ASCII (see Table 3), you
  already have pegs for A-Z and a-z. They will pop up at speed.
  You can either force them away or use them as with Method 2
  above, accepting the trade-off risk of collisions and ambiguity.

Radix-36, by the way, will work similarly in an obvious way for
either method. Tackling R64 gets you R36 "for free," so we won't
cover R36.
...
That's it for cross-checking; on to memorization. We'll tell a
tale of poisoning an indiscreet lover.
...
etc. These are for non-leap years only, so not great for computing
day-of-the-week. I have another method for that (debugged Furth's)
...
* TODO: Memorizing Dates

* TODO: Calculating Day of the Week
<<day-of-week>>

* All Pegs and Soundalikes
<<all-pegs>>

Letters for hex and Radix-64 are included in the row headers.
...
|     | sunshine    | censure    | cinch      | century   | ascension |             |
|   Q |             |            |            |           |           |             |
|-----+-------------+------------+------------+-----------+-----------+-------------|
...
|    | gain    | gown    | gun      | guinea | keen    | kin       |
|    | queen   | again   | acne     | agony  | awaken  | icon      |
|    | oaken   | wagon   |          |        |         |           |
|----+---------+---------+----------+--------+---------+-----------|
| 73 | comb    | cam     | calm     | cameo  | coma    | comma     |
|    | come    | game    | gam      | gum    | acme    | hokum     |
|    | oakum   | wigwam  |          |        |         |           |
|----+---------+---------+----------+--------+---------+-----------|
| 74 | car     | care    | carry    | coheir | cohere  | core      |
|    | cower   | crew    | crow     | cry    | cur     | cure      |
...
|    | collie  | clew    | claw     | clue   | gale    | gall      |
...
|    | vase   | vice     | vise     | visa    | voice     | phase   |
|    | efface | effuse   | office   |         |           |         |
|----+--------+----------+----------+---------+-----------+---------|
| 81 | fat    | fate     | feat     | feed    | fade      | faith   |
|    | fad    | feud     | fete     | fiat    | fight     | fit     |
...
|    | faro   | ferry    | fiery    | fir     | fire      | fray    |
...
|    | fill   | filly    | flaw     | flea    | flee      | flow    |
...
|    | vouch  | voyage   | affiche  | effigy  | offish    |         |
|----+--------+----------+----------+---------+-----------+---------|
| 87 | fig    | fag      | fake     | fang    | fog       | foggy   |
|    | fogie  | vague    | viewing  | vic     | vogue     | havoc   |
...
|    | piazza  | pious   | poise  | pose    | PS     | pussy    |
...
|    | behalf  | behave   | bevy   | biff    | buff    | buffo   |
|    | buffet  | above    | ab-ovo |         |         |         |
|----+---------+----------+--------+---------+---------+---------|
| 99 | baby    | pap      | peep   | pipe    | pip     | pop     |
|    | pope    | papa     | poppy  | puppy   | babe    | bib     |
...
|     | disuse       | dissuasive  | daisies      | deuces       | doses          | diocese     |
|-----+--------------+-------------+--------------+--------------+----------------+-------------|
| 101 | toast        | tacit       | taste        | test         | testimony      | Tuesday     |
|     | twist        | deceit      | decide       | deist        | destiny        | destitute   |
...
|     | disinfect    | disinterest | disown       | dissent      | dissonant      | dizziness   |
|     | Whitsunday   | Docent      |              |              |                |             |
|-----+--------------+-------------+--------------+--------------+----------------+-------------|
| 103 | twosome      | theism      | deism        | decimal      | disembark      | dismay      |
|     | dismember    | December    | dismiss      | dismount     | dissemble      | dissimilar  |
|     | atheism      | decimeter   | decimate     |              |                |             |
|-----+--------------+-------------+--------------+--------------+----------------+-------------|
| 104 | dicer        | thesaurus   | desert       | dessert      | deserve        | desire      |
|     | disarm       | disarrange  | discern      | dishearten   | disorder       | disregard   |
|     | disreputable | disroot     | dissertation | disrobe      | disrupt        | douser      |
|     | dowser       |             |              |              |                |             |
|-----+--------------+-------------+--------------+--------------+----------------+-------------|
| 105 | tassel       | diesel      | dazzle       | desolate     | disillusion    | dislike     |
|     | dislocate    | dissolve    | docile       | deciliter    | disloyal       | white-sale  |
|-----+--------------+-------------+--------------+--------------+----------------+-------------|
| 106 | dosage       | decision    | discharge    | dissuasion   | autosuggestion | wood-sage   |
|-----+--------------+-------------+--------------+--------------+----------------+-------------|
| 107 | tusk         | task        | desk         | disk         | discolor       | discomfort  |
|     | disclose     | disconnect  | discontent   | discord      | discount       | discourage  |
|     | discourse    | discover    | discrete     | discriminate | discuss        | disgrace    |
|     | disguise     | disgust     | disquiet     | dusk         | outskirts      | doeskin     |
|-----+--------------+-------------+--------------+--------------+----------------+-------------|
| 108 | tea-sieve    | theosophy   | deceive      | decipher     | disaffect      | disavow     |
|     | disfigure    | disfavor    | adhesive     | satisfaction |                |             |
|-----+--------------+-------------+--------------+--------------+----------------+-------------|
| 109 | teaspoon     | thespian    | toss-up      | despot       | despair        | deception   |
|     | decibel      | despite     | despond      | disabled     | diaspora       | disappear   |
...
|     | statesman    | status      | statistical | studious   |            |             |
|-----+--------------+-------------+-------------+------------+------------+-------------|
| 111 | teetotaler   | tete-a-tete | tidied      | dietetic   | day-duty   | deadwood    |
|     | doodad       | dotted      | doubted     | attitude   | audited    | outwitted   |
|-----+--------------+-------------+-------------+------------+------------+-------------|
| 112 | Titan        | Titanic     | tetanus     | tea-dance  | two-tone   | tidiness    |
|     | tighten      | deaden      | detain      | detonate   | dead-end   | sedateness  |
|     | steadiness   | stoutness   | student     |            |            |             |
|-----+--------------+-------------+-------------+------------+------------+-------------|
| 113 | diadem       | teatime     | two-timer   | tedium     | TeDeum     | totem       |
|     | datum        | daytime     | stadium     |            |            |             |
|-----+--------------+-------------+-------------+------------+------------+-------------|
| 114 | Tatar        | tater       | tea-tray    | tatter     | theater    | thither     |
|     | tooter       | totter      | tutor       | dater      | daughter   | deter       |
|     | deteriorate  | determine   | detract     | detriment  | daydreamer | diatribe    |
|     | auditor      | editor      | headwater   | hot-water  | stutter    |             |
|-----+--------------+-------------+-------------+------------+------------+-------------|
| 115 | tattle       | title       | tittle      | tidal      | tootle     | titillate   |
|     | total        | dawdle      | doodle      | dateline   | deadline   | dead-letter |
|     | deadly       | detail      | thoughtless | state-line |            |             |
|-----+--------------+-------------+-------------+------------+------------+-------------|
| 116 | detach       | deathwatch  | death-wish  | dotage     | hot-dish   | dead-issue  |
|-----+--------------+-------------+-------------+------------+------------+-------------|
| 117 | tie-tack     | toothache   | dating      | dedicate   | deduct     | detect      |
|     | detective    | tidings     | hot-dog     | idiotic    |            |             |
|-----+--------------+-------------+-------------+------------+------------+-------------|
| 118 | tutti-frutti | thoughtful  | dative      | dutiful    | dutyfree   | deadfall    |
|     | additive     | auditive    | auto-da-fe  | sedative   |            |             |
|-----+--------------+-------------+-------------+------------+------------+-------------|
| 119 | tadpole      | tea-table   | teddy-bear  | toothpick  | tidbit     | toothbrush  |
|     | deadbeat     | deadpan     | deathbed    | ditty-bag  |            |             |
|-----+--------------+-------------+-------------+------------+------------+-------------|

\clearpage
|-----+--------------+-------------+-------------+--------------+--------------+--------------|
| 120 | tinsel       | tenacity    | tennis      | tense        | thence       | tonsil       |
|     | dance        | dense       | dunce       | ad-nauseam   | Adonis       | Athens       |
|     | audience     | haughtiness | dynasty     | utensil      | whiteness    | witness      |
|     | sadness      |             |             |              |              |              |
|-----+--------------+-------------+-------------+--------------+--------------+--------------|
| 121 | tent         | taint       | taunt       | tenth        | tendon       | tend         |
|     | thunder      | tint        | tender      | twenty       | TNT          | twi-night    |
|     | tantalize    | dainty      | dandy       | denote       | dent         | dentist      |
|     | denude       | dint        | doughnut    | dwindle      | attend       | authentic    |
|     | addendum     | identical   | identify    | whodunit     | stand        | stint        |
|     | astound      |             |             |              |              |              |
|-----+--------------+-------------+-------------+--------------+--------------+--------------|
| 122 | tenant       | tenon       | teeny-weeny | denounce     | adonian      | Athenian     |
|     | hootenanny   |             |             |              |              |              |
|-----+--------------+-------------+-------------+--------------+--------------+--------------|
