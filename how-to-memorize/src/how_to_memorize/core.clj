...
(def bfnd ['(100000
           ...
           ;; Remove all words starting with S or Z and more than three hard
           ;; consonant sounds from pegs for 3-digit numbers starting with 0.
           ;; This change forces all 3-digit numbers starting with 0 to have
           ;; pegs with exactly three sounds starting with S/Z and all pegs with
           ;; more than three sounds starting with S/Z to belong to numbers that
           ;; don't start with zero. (3 Aug 2025)
           ...
           '((100015 "F")
             ...
             "stale"
             "steal"
             ;"cedilla" ;; 01 the way I pronounce ll as soft y
             )
...
(def cards '(("jail", "bat", 1, "SA", "TEA", "ALPHA", "ARYEH",
              "JAN 01"), ("judge", "bean", 2, "S2", "NOAH", "BAKER", "BAYIT",
              "JAN 08"), ("chalk", "beam", 3, "S3", "ME", "CHARLIE", "GAMAL",
              "JAN 15"), ("chef", "bar", 4, "S4", "RAY", "DELTA", "DALET",
              "JAN 22"), ("chip", "ball", 5, "S5", "LAW", "ECHO", "HAR",
              "JAN 29"), ("case", "badge", 6, "S6", "JAW", "FOXTROT", "VERED",
              "FEB 05"), ("cat", "back", 7, "S7", "KEY", "GOLF", "ZAHAV",
              "FEB 12"), ("can", "beef", 8, "S8", "FEE", "HOTEL", "CHAMOR",
              "FEB 19"), ("cam", "pipe", 9, "S9", "PEA", "INDIA", "TAYAS",
              "FEB 26"), ("car", "base", 10, "ST", "TOES", "JULIET", "YAD",
              "MAR 05"), ("coal", "potato", 11, "SJ", "TOT", "KILO", "KISEH",
              "MAR 12"), ("cage", "baton", 12, "SQ", "TAN", "LIMA", "LECHEM",
              "MAR 19"), ("cake", "podium", 13, "SK", "TAM", "MIKE", "MAYIM",
              "MAR 26"), ("cuff", "rat", 14, "HA", "TAR", "NOVEMBER", "NACHASH",
              "APR 02"), ("cap", "rain", 15, "H2", "TAIL", "OSCAR", "SEFER",
              "APR 09"), ("face", "ram", 16, "H3", "TISSUE", "PAPA", "AYIN",
              "APR 16"), ("fat", "rear", 17, "H4", "TACK", "QUEBEC", "PANIM",
              "APR 23"), ("fan", "rail", 18, "H5", "TAFFY", "ROMEO", "TZIPPOR",
              "APR 30"), ("fame", "rash", 19, "H6", "TAP", "SIERRA", "QUF",
              "MAY 07"), ("fare", "rack", 20, "H7", "NOSE", "TANGO", "ROSH",
              "MAY 14"), ("fall", "reef", 21, "H8", "NET", "UNIFORM", "SHAD",
              "MAY 21"), ("fish", "rope", 22, "H9", "NUN", "VICTOR", "TANIN",
              "MAY 28"), ("fig", "race", 23, "HT", "NAME", "WHISKEY", "",
              "JUN 04"), ("fife", "rat-a-tat", 24, "HJ", "NERO", "X-RAY", "",
              "JUN 11"), ("fob", "rattan", 25, "HQ", "NAIL", "YANKEE", "",
              "JUN 18"), ("base", "radium", 26, "HK", "NICHE", "ZULU", "",
              "JUN 25"), ("back", "cat", 27, "CA", "NECK", "alpha", "aryeh",
              "JUL 02"), ("beef", "can", 28, "C2", "NAVY", "baker", "bayit",
              "JUL 09"), ("pipe", "cam", 29, "C3", "NAP", "charlie", "gamal",
              "JUL 16"), ("thesis", "car", 30, "C4", "MASS", "delta", "dalet",
              "JUL 23"), ("toast", "coal", 31, "C5", "MAT", "echo", "har",
              "JUL 30"), ("dozen", "cage", 32, "C6", "MAN", "foxtrot", "vered",
              "AUG 06"), ("twosome", "cake", 33, "C7", "MAMA", "golf", "zahav",
              "AUG 13"), ("dowser", "cuff", 34, "C8", "MARE", "hotel", "chamor",
              "AUG 20"), ("diesel", "cap", 35, "C9", "MAIL", "india", "tayas",
              "AUG 27"), ("wood-sage", "case", 36, "CT", "MATCH", "juliet", "yad",
              "SEP 03"), ("tusk", "cadet", 37, "CJ", "MIKE", "kilo", "kiseh",
              "SEP 10"), ("adhesive", "katana", 38, "CQ", "MUFF", "lima",
              "lechem", "SEP 17"), ("teaspoon", "catamaran", 39, "CK", "MAP",
              "mike", "mayim", "SEP 24"), ("tights", "tot", 40, "DA", "RACE",
              "november", "nachash", "OCT 01"), ("teetotaler", "tan", 41, "D2",
              "RAT", "oscar", "sefer", "OCT 08"), ("titan", "tam", 42, "D3",
              "RAIN", "papa", "ayin", "OCT 15"), ("totem", "tar", 43, "D4", "RAM",
              "quebec", "panim", "OCT 22"), ("tatar", "tail", 44, "D5", "REAR",
              "romeo", "tzippor", "OCT 29"), ("title", "tissue", 45, "D6", "RAIL",
              "sierra", "quf", "NOV 05"), ("death-watch", "tack", 46, "D7",
              "RASH", "tango", "rosh", "NOV 12"), ("hot-dog", "taffy", 47, "D8",
              "RACK", "uniform", "shad", "NOV 19"), ("auto-da-fe", "tap", 48,
              "D9", "REEF", "victor", "tanin", "NOV 26"), ("teddy-bear", "toes",
              49, "DT", "ROPE", "whiskey", "", "DEC 03"), ("dance", "teetotaler",
              50, "DJ", "LACE", "x-ray", "", "DEC 10"), ("doughnut", "titan", 51,
              "DQ", "LOT", "yankee", "", "DEC 17"), ("athenian", "totem", 52,
              "DK", "LANE", "zulu", "", "DEC 24")))

(def orgulate    (partial interleave (repeat "|")))
(def backulate   #(conj (vec %) "|"))
(def frontulate  #(conj % "|"))
(def orgify      (comp backulate orgulate))
...
(defn chop-mem-line
  ...
  (let [furst
        ...
        (map
         orgofy
         (partition 6 6 nil (drop 7 line)))]
    (map stringulate (cons furst wryst))))

(defn fixline
  "Create a hash-table with three elements from a line. The three
  elements include a doctored number for cases with leading zeros,
  an alphabetic symbol for ASCII and other methods in the paper,
  and a list containing all the remaining sound-alikes. Must be
  mapped over a subvec of bfnd."
  [line]
  (let [f (first line)  ; should be a number or a list
        g (if (list? f)
            (first f)
            f)
...
(defn babnicate
  ...
  which repeats some of the code in here."
  [fixed-line]
  (let [l (:letter fixed-line)
        n (:num fixed-line)
        r (:rest fixed-line)]
    (if l
      (let [asciiulated-line
            (map stringulate
             (cons (orgify (cons n (take 6 r)))
                   (cons (orgify
                          (cons l (take 6 (drop 6 r))))
                         (map orgofy
                              (partition 6 6 nil (drop 12 r))))))]
        (map println (lindicate asciiulated-line)))
      (babulate (cons n r)))))
